...
public class CC_QAD extends ActionEngine {
	...
	@FindBy(xpath = "//small[text()='CC']")
	WebElement ChangeControlMyTask;

	@FindBy(id = "MyTaskPrc_CC_ISU_CC_QAD_FRM_01")
	WebElement CCQAD_SpMenu;
...
//		click(SubmitButton, "Submit");
		 ...
		 * Robot robot = new Robot(); robot.mouseMove(400, 5); // Navigating through
		 * mouse hover. Note that the coordinates might differ, kindly check the
		 * coordinates of x and y axis and update it accordingly.
		 * robot.mousePress(InputEvent.BUTTON1_DOWN_MASK); Thread.sleep(2000);
...
//		robot.keyRelease(KeyEvent.VK_D);
		...
		/*
		 * TimeUtil.shortWait(); driver.switchTo().alert().accept();
		 * //TimeUtil.shortWait(); //click(SubmitButton, "Submit");
	...
	public void ccQADReject(String reviewComments, String Category, String Remarks)
	...
	public void ccQADSelectiveReturn() {
		...
		scrollToViewElement(ChangeControlMyTask);
		click(ChangeControlMyTask, "Change control menu my task");
	...
	public void ccQAD_SP(String reviewComments, String Category) throws InterruptedException, AWTException {
		switchToBodyFrame(driver);
		scrollToViewElement(QAD_Menu);
		click(CCQAD_SpMenu, "QAD menu");
	...
	public void ccQADReject_SP(String reviewComments, String Category, String Remarks)
			throws InterruptedException, AWTException {
		switchToBodyFrame(driver);
		scrollToViewElement(QAD_Menu);
		click(CCQAD_SpMenu, "QAD menu");
	...
	public void ccQADSelectiveReturn_SP() {
		switchToBodyFrame(driver);
		scrollToViewElement(QAD_Menu);
		click(CCQAD_SpMenu, "QAD menu");
		switchToTaskListFrame(driver);
