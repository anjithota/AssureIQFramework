...
public class DocClosure_SP extends ActionEngine{
	@FindBy(xpath = "//small[text()='DN']")
	WebElement DocActionplanMyTask;
	
	@FindBy(id = "MyTaskPrc_DN_DN_CLS_FRM_ID_01")
	WebElement DocClosureMenu;
	...
	public void documentationClosure(String Comments) {
		switchToBodyFrame(driver);
		scrollToViewElement(DocActionplanMyTask);
		click(DocActionplanMyTask, "CLosure Menu");
		click(DocClosureMenu, "Documenation closure");
	...
	public void docClsInitiationEM(String Comments, String RefID, String FormId, String DeptId, String Description,
		...
		switchToBodyFrame(driver);
		scrollToViewElement(DocActionplanMyTask);
		click(DocActionplanMyTask, "Documentation my task Menu");
		scrollToViewElement(DocClosureMenu);
		click(DocClosureMenu, "documentaion closure menu");
