...
public class Audit_Responce_3Approval extends ActionEngine{
	...
	@FindBy(id="AUD_AR_CTF_015_error")
	WebElement HeadAuditeeCommentsError;
	
	@FindBy(id="AUD_AR_CTF_015")
	...
	public void audit_Finding_Responce_3AgainReturn(String reasons) {
		TimeUtil.shortWait();
		...
		click(SubmitButton, "Submit Button");
		E_sign.e_Sign(ConfigsReader.getPropValue("SPphanipwd"));
		switchToDefaultContent(driver);
	}
	
	public void auditResponce3Approve(String reasons) {
		TimeUtil.shortWait();
		switchToBodyFrame(driver);
		scrollToViewElement(InternalAudit);
		click(InternalAudit, "Internal Audit");
