...
public class ChangeControlLoginAgainReinitAuditTrail extends ActionEngine {
	...
	@FindBy(xpath = "(//div[@class='textdiv qsTitle']//span[text()='Revision No. 0 - Draft'])[2]")
...
//	WebElement dateInitiated;
	...
	public void ccLgnAgnReinitAT() {
		...
		// Title of Page
		System.out.println("\n" + "-----------------------------------");
		System.out.println("Title of the Page:- " + getText(pageTitleCCAT, "Change Control Login Audit Trail"));
